                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-flex flex-column min-width-0">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <?php else: ?>
                                    <img src="<?= $row->settings->favicon ? \Altum\Uploads::get_full_url('favicons') . $row->settings->favicon : get_favicon_url_from_domain(parse_url($row->full_url)['host']) ?>" class="img-fluid icon-favicon mr-1" loading="lazy" />
