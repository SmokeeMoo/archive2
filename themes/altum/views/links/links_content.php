                    ...
                    <form action="<?= url('links') ?>" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="<?= url('projects') ?>" target="_blank" class="small"><i class="fas fa-fw fa-sm fa-plus mr-1"></i> <?= l('global.create') ?></a>
                            </div>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-flex flex-column min-width-0">
                            <div class="d-inline-block text-truncate">
                                <a href="<?= url('link/' . $row->link_id) ?>" class="font-weight-bold"><?= $row->url ?></a><span class="badge badge-success <?= $this->user->type != 0 ? null : 'd-none' ?>" style="margin-left:0.3rem;"><?php $search=json_decode($row->settings, true); if ($search['theme_enable'] === true) { ?><?= l('link.settings.theme_onboard') ?><?php } ?></span><span class="badge badge-success <?= $this->user->type != 0 ? null : 'd-none' ?>" style="margin-left:0.3rem;"><?php $search=json_decode($row->settings, true); if ($search['theme_default'] === true) { ?><?= l('link.settings.theme_default_onboard') ?><?php } ?></span>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <?php if(settings()->links->qr_codes_is_enabled): ?>
                                <a href="<?= url('qr-code-create?name=' . $row->url . '&project_id=' . $row->project_id . '&type=url&url=' . $row->full_url) ?>" class="dropdown-item"><i class="fas fa-fw fa-sm fa-qrcode mr-2"></i> <?= l('qr_codes.link') ?></a>
                            <?php endif ?>
