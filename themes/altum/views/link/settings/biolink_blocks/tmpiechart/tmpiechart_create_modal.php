...
<div class="modal fade" id="create_biolink_tmpiechart" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= l('create_biolink_tmpiechart_modal.header') ?></h5>
            ...
            <div class="modal-body">
                <form name="create_biolink_tmpiechart" method="post" role="form">
