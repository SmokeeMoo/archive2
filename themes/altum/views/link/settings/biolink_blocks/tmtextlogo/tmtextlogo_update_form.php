...
<form name="update_biolink_" method="post" role="form">
    ...
    <input type="hidden" name="block_type" value="tmtextlogo" />
    <input type="hidden" name="biolink_block_id" value="<?= $row->biolink_block_id ?>" />

    <div class="notification-container"></div>

    <div class="form-group">
        <label for="<?= 'tmtextlogo_text_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= l('create_biolink_tmtextlogo_modal.text') ?></label>
        <input id="<?= 'tmtextlogo_text_' . $row->biolink_block_id ?>" class="form-control" name="text" maxlength="20" value="<?= $row->settings->text ?>" required="required" />
    </div>
        ...
        <div class="collapse" id="<?= 'button_settings_container_' . $row->biolink_block_id ?>">
            ...
            <div class="form-group">
			<label for="<?= 'font_size_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-font fa-sm mr-1"></i><?= l('create_biolink_textlogo_modal.font_size') ?></label>
            ...
            <div class="form-group">
                <label><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('create_biolink_tmtextlogo_modal.text_color') ?></label>
                <input type="hidden" name="text_color" class="form-control" value="<?= $row->settings->text_color ?>" required="required" />
                <div class="text_color_pickr"></div>
            </div>
            
            <div class="form-group">
                <label><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('create_biolink_tmtextlogo_modal.background_color') ?></label>
