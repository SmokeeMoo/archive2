...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="form-group">
        ...
        <select id="<?= 'paypal_type_' . $row->biolink_block_id ?>" name="type" class="custom-select">
    ...
    <div class="form-group">
        <label for="<?= 'paypal_email_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-envelope fa-sm text-muted mr-1"></i> <?= l('create_biolink_paypal_modal.email') ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'paypal_title_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-heading fa-sm text-muted mr-1"></i> <?= l('create_biolink_paypal_modal.title') ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'paypal_currency_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-euro-sign fa-sm text-muted mr-1"></i> <?= l('create_biolink_paypal_modal.currency') ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'paypal_price_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-dollar-sign fa-sm text-muted mr-1"></i> <?= l('create_biolink_paypal_modal.price') ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'paypal_thank_you_url_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-link fa-sm text-muted mr-1"></i> <?= l('create_biolink_paypal_modal.thank_you_url') ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'paypal_cancel_url_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-link fa-sm text-muted mr-1"></i> <?= l('create_biolink_paypal_modal.cancel_url') ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'paypal_name_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.name') ?></label>
    ...
    <div class="form-group" data-file-image-input-wrapper data-file-input-wrapper-size-limit="<?= settings()->links->thumbnail_image_size_limit ?>" data-file-input-wrapper-size-limit-error="<?= sprintf(l('global.error_message.file_size_limit'), settings()->links->thumbnail_image_size_limit) ?>">
        ...
        <?= include_view(THEME_PATH . 'views/partials/custom_file_image_input.php', [
            ...
            'accept' => \Altum\Uploads::array_to_list_format($data->biolink_blocks['paypal']['whitelisted_thumbnail_image_extensions']),
        ]) ?>
