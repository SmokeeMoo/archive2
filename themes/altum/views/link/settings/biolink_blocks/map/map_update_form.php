...
<form name="update_biolink_" method="post" role="form" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label for="<?= 'map_address_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-map-marker-alt fa-sm text-muted mr-1"></i> <?= l('create_biolink_map_modal.address') ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'map_location_url_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-link fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.location_url') ?></label>
        <input id="<?= 'map_location_url_' . $row->biolink_block_id ?>" type="text" class="form-control" name="location_url" value="<?= $row->location_url ?>" maxlength="2048" placeholder="<?= l('global.url_placeholder') ?>" />
    </div>

    <div class="form-group">
        <label for="<?= 'map_zoom_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-search fa-sm text-muted mr-1"></i> <?= l('create_biolink_map_modal.zoom') ?></label>
        <input id="<?= 'map_zoom_' . $row->biolink_block_id ?>" type="range"  min="1" max="20" class="form-control-range" name="zoom" value="<?= $row->settings->zoom ?>" required="required" />
    </div>

    <div class="form-group">
        <label for="<?= 'map_type_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-map fa-sm text-muted mr-1"></i> <?= l('create_biolink_map_modal.type') ?></label>
        <select id="<?= 'map_type_' . $row->biolink_block_id ?>" name="type" class="custom-select">
