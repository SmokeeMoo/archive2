...
<form name="update_biolink_" method="post" role="form">
    ...
    <input type="hidden" name="block_type" value="modal" />
    <input type="hidden" name="biolink_block_id" value="<?= $row->biolink_block_id ?>" />

    <div class="notification-container"></div>

    <div class="form-group">
        <label for="<?= 'modal_title_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('create_biolink_modal_modal.title') ?></label>
        <input id="<?= 'modal_title_' . $row->biolink_block_id ?>" class="form-control" name="title" value="<?= $row->settings->title ?>" required="required" />
    </div>
    
    <div class="form-group">
        <label for="<?= 'modal_text_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= l('create_biolink_modal_modal.text') ?></label>
        <textarea id="<?= 'modal_text_' . $row->biolink_block_id ?>" class="form-control" name="text" maxlength="2048"><?= $row->settings->text ?></textarea>
    </div>

   
            <div class="form-group">
                <label><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('create_biolink_modal_modal.text_color') ?></label>
            ...
            <div class="form-group">
                <label><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('create_biolink_modal_modal.background_color') ?></label>
