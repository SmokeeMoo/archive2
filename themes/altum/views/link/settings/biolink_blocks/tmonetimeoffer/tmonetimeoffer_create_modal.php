...
<div class="modal fade" id="create_biolink_tmonetimeoffer" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= l('create_biolink_tmonetimeoffer_modal.header') ?></h5>
