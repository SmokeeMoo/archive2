...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="form-group">
        <label for="<?= 'twitter_tweet_location_url_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-link fa-sm text-muted mr-1"></i> <?= l('create_biolink_twitter_tweet_modal.location_url') ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'twitter_tweet_theme_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-sun fa-sm text-muted mr-1"></i> <?= l('create_biolink_twitter_tweet_modal.theme') ?></label>
        <select id="<?= 'twitter_tweet_theme_' . $row->biolink_block_id ?>" name="theme" class="custom-select">
