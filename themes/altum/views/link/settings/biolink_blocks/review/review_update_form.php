...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="form-group">
        <label for="<?= 'review_title_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('create_biolink_review_modal.title') ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'review_description_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-pen fa-sm text-muted mr-1"></i> <?= l('create_biolink_review_modal.description') ?></label>
    ...
    <div class="form-group" data-file-image-input-wrapper data-file-input-wrapper-size-limit="<?= settings()->links->image_size_limit ?>" data-file-input-wrapper-size-limit-error="<?= sprintf(l('global.error_message.file_size_limit'), settings()->links->image_size_limit) ?>">
        <label for="<?= 'review_image_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-image fa-sm text-muted mr-1"></i> <?= l('create_biolink_review_modal.image') ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'review_author_name_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-user fa-sm text-muted mr-1"></i> <?= l('create_biolink_review_modal.author_name') ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'review_author_description_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-user-tag fa-sm text-muted mr-1"></i> <?= l('create_biolink_review_modal.author_description') ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'review_stars_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-star fa-sm text-muted mr-1"></i> <?= l('create_biolink_review_modal.stars') ?></label>
    ...
    <div class="collapse" id="<?= 'button_settings_container_' . $row->biolink_block_id ?>">
        <div class="form-group">
            <label for="<?= 'review_title_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('create_biolink_review_modal.title_color') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'review_description_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('create_biolink_review_modal.description_color') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'review_author_name_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('create_biolink_review_modal.author_name_color') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'review_author_description_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('create_biolink_review_modal.author_description_color') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'review_stars_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('create_biolink_review_modal.stars_color') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'review_background_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.background_color') ?></label>
