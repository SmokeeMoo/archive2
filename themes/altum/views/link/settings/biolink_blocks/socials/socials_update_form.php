...
<form name="update_biolink_" method="post" role="form" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label for="<?= 'socials_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('create_biolink_socials_modal.color') ?></label>
        <input type="hidden" id="<?= 'socials_color_' . $row->biolink_block_id ?>" name="color" class="form-control" value="<?= $row->settings->color ?>" required="required" />
        <div class="color_pickr"></div>
    </div>

    <div class="form-group">
        <label for="<?= 'socials_size_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-expand-alt fa-sm text-muted mr-1"></i> <?= l('create_biolink_socials_modal.size') ?></label>
        <select id="<?= 'socials_size_' . $row->biolink_block_id ?>" name="size" class="custom-select">
