...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="form-group">
        <label for="<?= 'external_item_name_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.name') ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'external_item_description_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= l('create_biolink_external_item_modal.description') ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'external_item_price_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-dollar-sign fa-sm text-muted mr-1"></i> <?= l('create_biolink_external_item_modal.price') ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'external_item_location_url_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-link fa-sm text-muted mr-1"></i> <?= l('create_biolink_external_item_modal.location_url') ?></label>
        <input id="<?= 'external_item_location_url_' . $row->biolink_block_id ?>" type="text" class="form-control" name="location_url" value="<?= $row->location_url ?>" maxlength="2048" placeholder="<?= l('global.url_placeholder') ?>" />
    </div>
    ...
    <div class="form-group" data-file-image-input-wrapper data-file-input-wrapper-size-limit="<?= settings()->links->thumbnail_image_size_limit ?>" data-file-input-wrapper-size-limit-error="<?= sprintf(l('global.error_message.file_size_limit'), settings()->links->thumbnail_image_size_limit) ?>">
        <label for="<?= 'external_item_image_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-image fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.image') ?></label>
        <?= include_view(THEME_PATH . 'views/partials/custom_file_image_input.php', [
            'id'=> 'external_item_image_' . $row->biolink_block_id,
            'uploads_file_key' => 'block_thumbnail_images',
            'file_key' => 'image',
            'already_existing_image' => $row->settings->image,
            'image_container' => 'image',
            'accept' => \Altum\Uploads::array_to_list_format($data->biolink_blocks['external_item']['whitelisted_thumbnail_image_extensions']),
        ]) ?>
    ...
    <div class="collapse" id="<?= 'button_settings_container_' . $row->biolink_block_id ?>">
        <div class="form-group">
            <label for="<?= 'external_item_name_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('create_biolink_external_item_modal.name_color') ?></label>
            <input id="<?= 'external_item_name_color_' . $row->biolink_block_id ?>" type="hidden" name="name_color" class="form-control" value="<?= $row->settings->name_color ?>" required="required" />
            <div class="name_color_pickr"></div>
        </div>
        ...
        <div class="form-group">
            <label for="<?= 'external_item_description_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('create_biolink_external_item_modal.description_color') ?></label>
            <input id="<?= 'external_item_description_color_' . $row->biolink_block_id ?>" type="hidden" name="description_color" class="form-control" value="<?= $row->settings->description_color ?>" required="required" />
            <div class="description_color_pickr"></div>
        </div>

        <div class="form-group">
            <label for="<?= 'external_item_price_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('create_biolink_external_item_modal.price_color') ?></label>
            <input id="<?= 'external_item_price_color_' . $row->biolink_block_id ?>" type="hidden" name="price_color" class="form-control" value="<?= $row->settings->price_color ?>" required="required" />
            <div class="price_color_pickr"></div>
        </div>

        <div class="form-group">
            <label for="<?= 'external_item_background_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.background_color') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'external_item_animation_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-film fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.animation') ?></label>
            <select id="<?= 'external_item_animation_' . $row->biolink_block_id ?>" name="animation" class="custom-select">
        ...
        <div class="form-group" data-animation="<?= implode(',', require APP_PATH . 'includes/biolink_animations.php') ?>">
            <label for="<?= 'external_item_animation_runs_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-play-circle fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.animation_runs') ?></label>
            <select id="<?= 'external_item_animation_runs_' . $row->biolink_block_id ?>" name="animation_runs" class="custom-select">
