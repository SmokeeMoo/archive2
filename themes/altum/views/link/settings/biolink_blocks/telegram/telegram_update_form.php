...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="form-group">
        <label for="<?= 'telegram_location_url_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-video fa-sm text-muted mr-1"></i> <?= l('create_biolink_telegram_modal.location_url') ?></label>
        <input id="<?= 'telegram_location_url_' . $row->biolink_block_id ?>" type="url" class="form-control" name="location_url" value="<?= $row->location_url ?>" placeholder="<?= l('create_biolink_telegram_modal.location_url_placeholder') ?>" required="required" />
    </div>
